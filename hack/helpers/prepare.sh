...
sed -i.bak "s/provider-secret/provider-${ProviderNameLower}/g" go.mod
...
git mv "cluster/images/provider-secret" "cluster/images/provider-${ProviderNameLower}"
git mv "cluster/images/provider-secret-controller" "cluster/images/provider-${ProviderNameLower}-controller"
